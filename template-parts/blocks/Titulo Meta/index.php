...
<div class="metainvisible text-center" style=" padding:100px 0px 100px 0px; background: black; color: white; width: 100%;">
    <h1 class="hero-content-section__title mb-5" style="color: white; text-transform: uppercase; margin-top: inherit;"><?php echo get_field("titulo_meta")?></h1>
            <div class="text-center" style="width:28% ; margin-left: auto; margin-right: auto; ">
                <p class="text-center" style="font-family: GTAmericaExpandedRegula;line-height: 15px; color:white !important; font-size: 15px;"> <?php echo get_field("texto_meta")?> </p>
            </div>
</div>
...
<div class="convictorymeta" style=" background: black; color: white !important;">
    <section class="main row  align-items-center" style="width:60% ; margin-left: auto; margin-right:auto;">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 order-2 order-md-1 text-center" style="text-align: left">
            ...
            <h2 style="font-size: 22px; width:38%; font-weight:900; text-align:left; margin-bottom: 50px; text-transform: uppercase; "><?php echo get_field("edicion_especial")?></h2>
