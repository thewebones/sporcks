...
<div class="convictorymeta" style=" background: black; color: white !important;">
    <section class="main row  align-items-center" style="width:80% ; margin-left: auto; margin-right:auto;">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 order-2 order-md-1 text-center" style="text-align: left">
            ...
            <h2 style="font-size: 20px; font-weight:900; text-align:left; margin-bottom: 50px; text-transform: uppercase; "><?php echo get_field("edicion_especial")?></h2>
            <p style="font-family: GTAmericaExpandedRegular; margin-bottom: 50px; font-size: 15px; color:white !important; text-align: left; line-height: 15px;"><?php echo get_field("edicion_texto")?></p>
