 ...
 * Checkout Form
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/checkout/form-checkout2.php.
 *
                    ...
                    <div class="checkout-form__row">
					  ...
					  <label class="checkout-form__label" for="checkoutEmailField"><?php echo get_field("span_arriba_del_input","option")?></label>
					   <?php woocommerce_form_field('billing_email', array('placeholder' => 'your e-mail *', 'required' => true), $checkout->get_value('billing_email')); ?>
                         ...
                         <!--<input clacheckout2kout-form__input" type="email" id="checkoutEmailField" email="" require="" placeholder="Your e-mail"> -->
                  ...
                  <div class="checkout-address-form checkout-form">
                    ...
                    <div class="checkout-form__row">
                      <div class="checkout-form__control">
						...
						<!-- <select clacheckout2kout-form__input" id="countryField">
                    ...
                    <div class="checkout-form__row">
                      <div class="checkout-form__cols checkout-form__cols--50-50">
                        <div class="checkout-form__control">
                          ...
                          <!-- <input clacheckout2kout-form__input" type="text" id="firstNameField" require="" placeholder="First name"> -->
                        </div>
                        <div class="checkout-form__control">
						  ...
						  <!-- <input clacheckout2kout-form__input" type="text" id="lastNameField" require="" placeholder="Last name"> -->
                        </div>
                      </div>
                    </div>
                    <div class="checkout-form__row">
                      <div class="checkout-form__control">
						...
						<!-- <input clacheckout2kout-form__input" type="text" id="streetField" require="" placeholder="Street"> -->
                      </div>
                    </div>
                    <div class="checkout-form__row">
                      <div class="checkout-form__cols checkout-form__cols--25-75">
                        <div class="checkout-form__control">
                          ...
                          <!-- <input clacheckout2kout-form__input" type="text" id="zipCodeField" require="" placeholder="Post code / Zip"> -->
                        </div>
                        <div class="checkout-form__control">
                          ...
                          <!-- <input clacheckout2kout-form__input" type="text" id="cityField" require="" placeholder="City / Town"> -->
                        </div>
                      </div>
                    </div>
                    <div class="checkout-form__row">
                      <div class="checkout-form__cols checkout-form__cols--25-75">
                        ...
                        <div class="checkout-form__control">
						  ...
						  <!-- <input clacheckout2kout-form__input" type="text" id="phoneField" placeholder="Phone number"> -->
                        </div>
